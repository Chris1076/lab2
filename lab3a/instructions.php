...
<section class="section">
    ...
    <h2 class="subtitle">
        Greetings, <?php echo $complete_name;?>This is the IPT10 PHP Quiz Web Application Laboratory Activity.
    </h2>
    ...
    <form method="POST" action="quiz.php">
        ...
        <div class="field">
            <div class="control">
                ...
                <input type="checkbox" name="disagree" onchange="checkTerms(this);">
        ...
        <!-- Start Quiz button -->
        <button type="submit" id="submitBtn" class="button is-link">Start Quiz</button>
    </form>
</section>
